...
for quiz_num in range(3):
    ...
    # names the first quiz and answer key capitalsquiz1.txt and capitalsquiz _answers1.txt.
    # We create these files with calls to the open() function
    ...
    # The write() statements create a quiz header for the student to fill out.
    quiz_file.write('Name:\n\nDate:\n\nPeriod:\n\n')
    quiz_file.write((' ' * 20) + f'State Capitals Quiz (Form{quiz_num + 1})')
    quiz_file.write('\n\n')

    # Shuffle the order of the states.
    # a randomized list of US states is generated with the help of
    # the random.shuffle() function, which randomly reorders the values
